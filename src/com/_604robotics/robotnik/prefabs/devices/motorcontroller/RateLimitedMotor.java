package com._604robotics.robotnik.prefabs.devices.motorcontroller;
...
public class RateLimitedMotor {
  ...
  public RateLimitedMotor(
      Encoder encoder, double nominalRate, double tolerance, PWMSpeedController motor) {
  ...
  public void set(double power) {
    ...
    motor.set(
        (power > 0)
            ...
            : // then use slower of power and maxpowerup
            ((power < maxPowerDown)
                ? maxPowerDown
                : power)); // else use slower of power and maxpowerdown
  }
