...
public class ResettablePIDSource implements PIDSource {
  ...
  /**
   * Sets the zero value of the PID such that it would read the given real value at the current raw
   * value.
   *
  ...
  /**
   * Sets the zero value of the PID such that it would read the given real value if it were at the
   * given raw value.
   *
