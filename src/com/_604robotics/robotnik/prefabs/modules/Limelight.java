...
public class Limelight extends Module {
  ...
  /**
   * Represents the horizontal angle error of the robot in degrees. Has a maximum range of -27 to 27
   * degrees.
   */
  ...
  /**
   * Represents the vertical angle error of the robot in degrees. Has a maximum range of -20.5 to
   * 20.5 degrees.
   */
  ...
  /**
   * Represents the distance error of the robot in the same units as used in the Calibration file
   * (should be inches). Maximum range depends on the calibration of the Limelight's scanning.
   */
  public static class DistanceError implements PIDSource {
    ...
    /**
     * Creates a new PIDSource representing the distance from a calibrated target using the angle of
     * the limelight relative to the target
     *
     * @param limelight The limelight object representing the limelight
     * @param distance Goal distance the limelight should be from the target. If 0, the robot will
     *     likely be trying to enter a wall
     */
