...
public class RotatingArmPIDController extends NewExtendablePIDController {
    ...
    public RotatingArmPIDController(double Kp, double Ki, double Kd, DoubleSupplier source, DoubleConsumer output) {
    ...
    public RotatingArmPIDController(double Kp, double Ki, double Kd, double Kf, DoubleSupplier source, DoubleConsumer output) {
