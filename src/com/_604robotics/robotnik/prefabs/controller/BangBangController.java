...
/**
 * Implements a bang-bang type speed controller. Due to the nature of the algorithm, precise update
 * frequencies are unimportant. This implementation uses PIDSource and PIDOutput interfaces for
 * compatibility.
 */
@Deprecated
@Untested("Needs to be tested with actual spinning wheel")
