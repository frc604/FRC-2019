...
public class SmartTimer extends Timer {
   ...
   * @return boolean representing whether the timer has not finished running. Returns FALSE if
   *     FINISHED.
   */
  ...
  /**
   * Method that runs a Runnable periodically. <b>Note that the timer is reset when the Runnable is
   * executed.</b>
   *
