...
public abstract class Robot_Old extends RobotBase {
  ...
  private static final Logger logger = new Logger(Robot_Old.class);
  ...
  public Robot_Old(double reportInterval) {
  ...
  private void loop(String name, Coordinator mode, Supplier<Boolean> active) {
    ...
    while (active.get()) {
      ...
      if (mode != null) {
        iterationTimer.sample(loopTime -> logger.info("Loop time: " + loopTime * 1000 + " ms"));
      }
    }
