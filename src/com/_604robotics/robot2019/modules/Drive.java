...
public class Drive extends Module {
    ...
    public void updateOdometry() {
        m_driveOdometry.update(Rotation2d.fromDegrees(getHeading()),
    ...
    /* Kinematics */
    public DifferentialDriveKinematics m_driveKinematics = new DifferentialDriveKinematics(Calibration.Drive.TRACK_WIDTH);

    public DifferentialDriveOdometry m_driveOdometry = new DifferentialDriveOdometry(m_driveKinematics, Rotation2d.fromDegrees(getHeading()));
