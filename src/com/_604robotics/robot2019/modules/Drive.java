...
public class Drive extends Module {
    private final RampMotor m_frontLeft = new RampMotor(new VictorSP(Ports.DRIVE_FRONT_LEFT_MOTOR),Calibration.DRIVE_MOTOR_RAMP);
    private final RampMotor m_rearLeft = new RampMotor(new VictorSP(Ports.DRIVE_REAR_LEFT_MOTOR),Calibration.DRIVE_MOTOR_RAMP);
    private final SpeedControllerGroup m_left = new SpeedControllerGroup(m_frontLeft, m_rearLeft);

    private final RampMotor m_frontRight = new RampMotor(new VictorSP(Ports.DRIVE_FRONT_RIGHT_MOTOR),Calibration.DRIVE_MOTOR_RAMP);
    private final RampMotor m_rearRight = new RampMotor(new VictorSP(Ports.DRIVE_REAR_RIGHT_MOTOR),Calibration.DRIVE_MOTOR_RAMP);
