...
public class Dashboard extends DashboardModule {
  ...
  /* Limelight Settings */
  public final Output<Limelight.LEDState> limelightLEDState =
      addDashboardOutput("LED Mode", Limelight.LEDState.ON, Limelight.LEDState.class);
  public final Output<Limelight.StreamMode> limelightStreamMode =
      addDashboardOutput("Stream Mode", Limelight.StreamMode.STANDARD, Limelight.StreamMode.class);
  public final Output<LimelightMode> limelightVisionMode =
      addDashboardOutput("VisionMode", LimelightMode.DRIVER, LimelightMode.class);
  ...
  public final Output<DriveMode> driveMode =
      addDashboardOutput("driveMode", DriveMode.ARCADE, DriveMode.class);
