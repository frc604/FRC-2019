...
public class TrajectoryTracker extends Coordinator {
    ...
    Drive drivetrain) {
        ...
        m_feedforward = new SimpleMotorFeedforward(Calibration.Auto.KS_VOLTS,
	...
	public void begin() {
        ...
        m_prevSpeeds = m_drivetrain.m_driveKinematics.toWheelSpeeds(
	...
	public boolean run() {
        ...
        var targetWheelSpeeds = m_drivetrain.m_driveKinematics.toWheelSpeeds(
        ...
        leftOutput = leftFeedforward
            + m_leftVelController.calculate(m_drivetrain.getWheelSpeeds().leftMetersPerSecond,
            leftSpeedSetpoint);

        rightOutput = rightFeedforward
            + m_rightVelController.calculate(m_drivetrain.getWheelSpeeds().rightMetersPerSecond,
            rightSpeedSetpoint);
