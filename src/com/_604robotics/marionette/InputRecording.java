...
public class InputRecording {
  ...
  public synchronized void setRawAxis(
      final int frame, final int joystick, final int axis, final double value) {
  ...
  public synchronized void setRawButton(
      final int frame, final int joystick, final int button, final boolean value) {
